...
#define CHANNEL 1
#define RE_ADDR "serv1"
#define TR_ADDR "peri1"
...
byte message[MAX_PAYLOAD_LENGTH]={"ABCDEFGHIJKLMNOPQRSTUVWXYZ012345"};
...
void loop() {
  ...
  Serial.print("sending...");Serial.println((char*)message);
